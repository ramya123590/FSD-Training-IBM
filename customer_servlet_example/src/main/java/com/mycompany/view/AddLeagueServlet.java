...
public class AddLeagueServlet extends HttpServlet {
  ...
  private List<String> l=null;
	...
	out.println("<!DOCTYPE html>\n" + 
			...
			"\n" + 
			"    \n" + 
			"    <input type=\"text\" id=\"defaultLoginFormPassword\" class=\"form-control mb-4\" placeholder=\"type\" name=\"id\">\n" + 
			"\n" + 
			" <select class=\"browser-default custom-select\" name=\"type\">\n" + 
			"  <option value=\"Unknown\">Select A id</option>\n" + 
			"  <option value=\"Winter\">Customer-normal</option>\n" + 
			"  <option value=\"Summer\">Customer-corporate</option>\n" + 
